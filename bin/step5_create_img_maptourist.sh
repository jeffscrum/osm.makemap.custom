...
java $JAVAMEM -jar $TOOLSDIR/mkgmap/mkgmap.jar --verbose \
        ...
        --housenumbers \
  $BASEDIR/styles/maptourist.typ \
  $BASEDIR/split.$1/*.pbf

echo "Copy $BASEDIR/img.$1/gmapsupp.img to $BASEDIR/map/MapTourist_$1.img"
mv $BASEDIR/img.$1/gmapsupp.img $BASEDIR/map/MapTourist_$1.img
echo "Done."

cd $BASEDIR/map
$sum MapTourist_$1.img > MapTourist_$1.img.sha1

echo '# '`date` >> MapTourist_$1.img.sha1 
