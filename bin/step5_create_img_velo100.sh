...
java $JAVAMEM -jar $TOOLSDIR/mkgmap/mkgmap.jar --verbose \
        --gmapsupp --tdbfile \
        --mapname=$TILESNUM \
        ...
        --style-file=$BASEDIR/styles/stranger/ \
        --remove-short-arcs \
        ...
        --housenumbers \
  $BASEDIR/styles/stranger.typ \
  $BASEDIR/split.$1/*.pbf

echo "Copy $BASEDIR/img.$1/gmapsupp.img to $BASEDIR/map/Velo100_$1.img"
mv $BASEDIR/img.$1/gmapsupp.img $BASEDIR/map/Velo100_$1.img
echo "Done."

cd $BASEDIR/map
$sum Velo100_$1.img > Velo100_$1.img.sha1

echo '# '`date` >> Velo100_$1.img.sha1 
